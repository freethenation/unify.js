(function() {
  var Box, DICT_FLAG, DictFlag, HIDDEN_VAR_PREFIX, Tin, Variable, bind, bind_tins, boxit, extern, g_hidden_var_counter, get_tin, isHiddenVar, isarray, isbool, isfunc, isnum, isobj, isstr, isundef, isvaluetype, parse, rollback, str, toJson, unboxit, unify, _unify;
